...
a – Définition et conditions d’existence des différends
 ...
 Question : Quelles conditions doivent être réunies pour que l’on puisse conclure à l’existence d’un différend entre un État X et un État Y ? 
 Réponse : Tout désaccord entre deux ou plusieurs États ne constitue pas un différend selon la jurisprudence internationale. Deux conditions doivent être cumulativement réunies pour que l’on puisse conclure à l’existence d’un différend entre un État X et un État Y :
...
Seconde condition : Le rejet explicite ou implicite de cette réclamation par l’État Y.
 Autrement dit, la Cour internationale de Justice (ci-après dénommée « la Cour » ou « la CIJ ») conclut à l’existence d’un différend entre un État X et un État Y  
...
* Nota bene : 
       ...
       * Le rejet des griefs par l’État Y peut être explicite ou implicite (c’est-à-dire déduit d’un comportement tel qu’un silence anormalement long).
 Question : À quelle date un différend survient-il entre deux parties ? 
...
En conséquence, la date de la naissance (juridique) du différend est la suivante :la date à laquelle la réclamation a été rejetée par l’État Y destinataire de la réclamation.
 Soulignons que la jurisprudence internationale et la pratique diplomatique consacrent l’usage du mot de différend (en anglais : dispute), de préférence à des termes tels que conflit ou litige.
**

b – Principes régissant la qualification de différend
 La définition que la Cour permanente de Justice internationale a donnée de la notion de différend le 30 août 1924, en l’affaire Mavrommatis, (Voir supra 10) a été fidèlement et constamment reprise
* par la Cour internationale de Justice
* et par toutes les autres juridictions internationales. 
 Pourtant, cette définition ne tranche pas directement la question centrale que pose la qualification de différend : 
À qui appartient-il, en dernier ressort, de qualifier de différend une affaire mettant aux prises, par exemple, un État X et un État Y 
 L’examen de la pratique internationale révèle que bien souvent lorsqu’un État X assigne un État Y devant la Cour, le premier moyen de défense de l’État Y consiste à nier l’existence du différend allégué par l’État X.
 La fréquence de ces désaccords sur l’existence de différends a conduit la Cour internationale de Justice (dénommée ci-après « la CIJ » ou « la Cour ») à énoncer trois principes aux fins de la qualification de différend. 
      Premier principe.    Il appartient, en dernier ressort, à la Cour de juger qu’il existe ou non un différend entre un État X et un État Y, que l’affaire qui les oppose peut ou non être qualifiée de différend. Qui plus est, « la détermination par la Cour de l’existence d’un différend est une question de fond, et non de forme ou de procédure ».
      Deuxième principe.    Le différend doit exister à la date de la saisine de la Cour, sinon celle-ci est incompétente. 
      Troisième principe.   Les déclarations faites devant la Cour par des États X et Y au sujet de l’existence d’un différend entre eux ne lient pas ipso facto la Cour.
* Exemples de déclarations que les États X et Y pourraient faire devant la Cour :
...
Aucune de ces trois déclarations n’obligera la Cour à dire qu’il existe ou qu’il n’existe pas de différend entre l’État X et l’État Y.
 La Cour se livrera à sa propre appréciation des faits pour juger qu’il existe ou non un différend entre l’État X et l’État Y – Affaires du Sud-Ouest africain (Ethiopie c. Afrique du Sud; Libéria c. Afrique du Sud), Exceptions préliminaires, Arrêt du 21 décembre 1962. C.I.J. Recueil 1962, p. 319.
 Pour ce faire, la Cour « tient compte notamment de toute déclaration ou de tout document échangé entre les Parties, ainsi que de tout échange ayant eu lieu dans des enceintes multilatérales. » — Application de la convention pour la prévention et la répression du crime de génocide dans la bande de Gaza (Afrique du Sud c. Israël), mesures conservatoires, Ordonnance du 26 janvier 2024. C.I.J. Recueil 2024.
 Concrètement, la Cour vérifiera que les deux conditions nécessaires à l’existence d’un différend sont réunies : 
1. L’État X, par exemple, a formulé une réclamation contre l’État Y et l’a portée à sa connaissance.
2. L’État Y a rejeté explicitement ou implicitement cette réclamation.
**
2 – La question de la justiciabilité des différends
a – Les différends justiciables et les différends non justiciables
 À en croire une partie de la doctrine du droit international, il existerait deux catégories de différends :
* La catégorie des différends justiciables 
* et celle des différends non justiciables.
 Qui plus est, la catégorie des différends non justiciables comprendrait deux sous-catégories :
...
Définition de la notion de différend non justiciable :
Un différend non justiciable est un différend insusceptible d'être soumis valablement à une juridiction internationale.
Exemples : 
* Un différend politique est en principe un différend non justiciable par nature. 
...
Règlement : Ce terme est pris ici dans le sens que lui donne la Charte des Nations Unies, et non dans son acception habituelle d’acte fixant des dispositions à caractère général.
Dans ce cours, le mot de règlement désigne « le fait de régler, de trancher un litige ».
Quant à l’expression « mode de règlement », elle signifie, simplement et logiquement, « manière de de régler, de trancher un litige ».
Classification
 Il est plusieurs manières de classer les modes de règlement des différends internationaux. Néanmoins, la classification la plus pertinente juridiquement est celle qui distingue
* d'une part, les modes juridictionnels de règlement des différends internationaux
* et d’autre part, les modes diplomatiques de règlement des différends internationaux.
Le critère de la distinction, c’est la portée des décisions issues de chaque catégorie de modes de règlement.
Les modes juridictionnels de règlement des différends internationaux débouchent sur des décisions (jugements, arrêts ou sentences arbitrales) ayant une portée obligatoire pour les parties.
Les modes diplomatiques de règlement des différends internationaux débouchent sur des décisions politiques dépourvues de portée obligatoire pour les parties, sauf engagement contraire de la part de ces dernières.
Cette différence est logique, car, au contraire des modes diplomatiques de règlement, les modes juridictionnels de règlement sont mis en œuvre par des judications : cours de justice, tribunaux arbitraux.
Le contenu précis de ces deux catégories de mode de règlement sera présenté ci-après.
**
2 – La prise en compte du recours licite à des contre-mesures
 En ce qui concerne le règlement des différends internationaux, la Charte des Nations Unies énonce deux obligations solidaires.
Elle proscrit le recours par les États à la menace ou à l’emploi de la force.
Article 2, paragraphe 4 de la Charte : 
« Les membres de l’Organisation s’abstiennent, dans leurs relations internationales, de recourir à la menace ou à l’emploi de la force, soit contre l’intégrité territoriale ou l’indépendance politique de tout État, soit de toute autre manière incompatible avec les buts des Nations Unies. » 
Elle oblige les États à régler leurs différends internationaux par des moyens pacifiques.
...
« Les parties à tout différend dont la prolongation est susceptible de menacer le maintien de la paix et de la sécurité internationales doivent en rechercher la solution, avant tout, par voie de négociation, d'enquête, de médiation, de conciliation, d'arbitrage, de règlement judiciaire, de recours aux organismes ou accords régionaux, ou par d'autres moyens pacifiques de leur choix. »
 ...
 De valeur à la fois coutumière et conventionnelle, l’interdiction du recours à la force dans les relations interétatiques admet actuellement, on le sait, deux exceptions : 
* légitime défense (article 51 de la Charte) 
* et action coercitive décidée par le Conseil de sécurité en vertu du chapitre VII de la Charte. 
 Le recours à des contre-mesures (n’impliquant évidemment pas l’usage de la force armée) est également licite. 
...
Les effets de la contre-mesure doivent être proportionnés aux dommages subis, compte tenu des droits en cause ;
La contre-mesure doit avoir pour but d'inciter l'État auteur du fait illicite à exécuter les obligations qui lui incombent en vertu du droit international ; 
Enfin la mesure prise doit être réversible – Projet Gabíkovo-Nagymaros, (Hongrie/Slovaquie), Arrêt du 25 septembre 1997. C.I.J. Recueil 1997, p. 7. 
...
3 – La mise en exergue des modes juridictionnels de règlement des différends internationaux
Rappel de la définition du droit du contentieux international :
Le droit du contentieux international, c'est l'ensemble des normes de fond et de procédure qui gouvernent le règlement juridictionnel de différends opposant des sujets de droit international.
 On l’aura compris, cette définition met en exergue et donc place au cœur de notre cours les modes juridictionnels de règlement des différends internationaux.
Ces modes juridictionnels de règlement des différends internationaux se composent de deux types :
Le règlement judiciaire, essentiellement devant la Cour internationale de Justice (Chapitre 1er de la première partie du cours)
Le règlement arbitral, qui est l’office des juridictions arbitrales (Chapitre 2 de la seconde partie du cours)
**
4 – La prise en considération des modes diplomatiques de règlement des différends internationaux
 Les modes diplomatiques de règlement des différends, encore appelés parfois « modes politiques de règlement », sont des modes non juridictionnels de règlement des différends.
a – La nomenclature des modes diplomatiques de règlement des différends internationaux
 Les modes diplomatiques de règlement des différends internationaux sont énumérés, d’ailleurs de manière juridiquement non exhaustive1, à l’article 33, paragraphe 1, (précité) de la Charte des Nations Unies :
* Négociation, 
* Médiation,
* Bons offices,
* Enquête internationale,
* Conciliation. 
 Au contraire des modes juridictionnels, les modes diplomatiques n’ont pas forcément une portée contraignante.
**
b – Les trois grands principes communs aux modes diplomatiques de règlement des différends internationaux
Trois précisions liminaires :
Première précision. 
De toute cette partie du cours relative aux modes diplomatiques de règlement des différends, les seuls éléments à retenir en vue de l’examen, ce sont les trois grands principes qui seront exposés ci-après.
Pourquoi  Parce que 
  o d’une part, ces trois grands principes correspondent aux trois questions qui se posent devant la Cour au sujet des modes diplomatiques de règlement des différends,
  o et d’autre part, l’épreuve écrite d’examen sera nécessairement un cas pratique comparable à une affaire soumise à la Cour.
Deuxième précision.   Ces trois grands principes, qui seront exposés ci-dessous, régissent tous les modes diplomatiques de règlement des différends.

Troisième précision.  Ces trois grands principes sont en fait les réponses à trois questions :
Les parties à un différend sont-elles obligées de recourir à un mode diplomatique précis de règlement des différends internationaux, c’est-à-dire de recourir
* à la négociation 
...
Oui, les parties sont obligées de recourir à un mode diplomatique précis de règlement des différends internationaux si elles ont conclu un accord à cet effet, c’est-à-dire si elles en ont pris l’engagement.
 Deuxième principe, Réponse à la question n°2 : 
 À l’occasion de l’exercice d’un mode diplomatique de règlement des différends internationaux auquel elles ont accepté de recourir, les parties n’ont pas une obligation de résultat. Elles ne sont pas tenues de parvenir à un accord mettant fin à leur différend.
Exemple : « L’engagement de négocier n'implique pas celui de s'entendre. » – Trafic ferroviaire entre la Lithuanie et la Pologne (Section de ligne Landwarów-Kaisiadorys), Avis consultatif du 15 octobre 1931. CPJI, série A/B n°42. 
 De jurisprudence constante, à l’occasion de l’exercice d’un mode diplomatique de règlement des différends internationaux auquel elles ont accepté de recourir, les parties ont plutôt une obligation de comportement fondée sur la bonne foi. Une obligation que nous pouvons décomposer comme suit :
 Obligation non seulement de recourir à ce mode diplomatique de règlement des différends internationaux puisqu’elles en ont pris l’engagement, mais encore d’en poursuivre autant que possible l’exercice, en vue de parvenir à un accord ;
 Obligation de se comporter de telle sorte que l’exercice de ce mode diplomatique de règlement des différends internationaux ait un sens.
Troisième principe, Réponse à la question n°3 : Non, sauf engagement contraire.
Donc la réponse détaillée est : Oui et non. 
Non, en principe, une solution issue de l’exercice d’un mode diplomatique de règlement des différends internationaux n’est pas obligatoire pour les parties et ne met donc pas fin ipso facto au différend qui les oppose.
Oui, une solution issue de l’exercice d’un mode diplomatique de règlement des différends internationaux est obligatoire pour les parties si elles ont pris l’engagement de se conformer à cette solution qui met ainsi fin au différend qui les oppose
*
...
Certes, elle permet aux parties de prendre langue directement. 
Mais le face-à-face sur lequel se fonde la négociation expose le plus faible à la pression directe du plus fort. L’accord qui en résulte est souvent entaché d’un vice du consentement parce que basé sur un rapport de forces.
*
...
En effet, le contentieux international relève du droit international. Or, pendant longtemps, les États ont été considérés comme les seuls sujets du droit international. 
...
[1. Only states may be parties in cases before the Court.]
 Autrement dit, seuls des États peuvent être demandeurs ou défendeurs dans une affaire contentieuse soumise à la Cour.
...
2 – La justice internationale, une justice primaire 
 De ce que les États sont sinon exclusivement, du moins principalement les acteurs du contentieux international découlent plusieurs conséquences. 
...
En effet, bien souvent, les États cherchent d’abord à régler leurs différends par des modes diplomatiques (négociation, médiation, etc.).
Donc, le plus souvent, ils ne saisissent une juridiction internationale qu’en cas d’échec des modes diplomatiques de règlement. 
 Les citations qui vont suivre illustrent le caractère supplétif du recours aux juridictions internationales.
« Il paraît bien désirable qu'un État ne procède pas à une démarche aussi sérieuse que l'assignation d'un autre État devant la Cour, sans avoir auparavant, dans une mesure raisonnable, tâché d'établir clairement qu'il s'agit d'une différence de vues qui ne peut être dissipée autrement. » – Interprétation des arrêts n° 7 et 8 (Usine de Chorzów), Arrêt n°11 du 16 décembre 1927. CPJI, série A n°13.
« Le règlement judiciaire des conflits internationaux, en vue duquel la Cour est instituée, n'est qu'un succédané au règlement direct et amiable de ces conflits entre les Parties ; » – Affaire des zones franches de la Haute-Savoie et du pays de Gex, Ordonnance du 19 août 1929. CPJI, série A n°22, p. 522. 
**
b – Une justice facultative 
 Une juridiction internationale n’est compétente pour statuer sur un différend qu’à la condition suivante : 
* que toutes les parties à ce différend aient donné leur consentement à la compétence de cette juridiction.
Qui plus est, elles ne sont pas obligées de donner leur consentement.
 Mais si elles ont donné leur consentement, chacune d’elle, prise isolément, est obligée de comparaître devant la juridiction internationale en question.
 Donc, le recours à une juridiction internationale est
o facultatif avant que les parties ne donnent leur consentement,
o obligatoire lorsque les parties ont donné leur consentement (Mais elles peuvent décider par accord de ne pas aller devant la juridiction en question).
 Le paradoxe n’est qu’une apparence :
« La juridiction de la Cour dépend de la volonté des Parties. » – Droits de minorités en Haute-Silésie (écoles minoritaires), Arrêt du 26 avril 1928. CPJI, série A n°15.
**
c – Une justice éclatée 
 Il n’y a pas, dans la société internationale, d’organisation judiciaire générale, comportant une hiérarchie formelle de tribunaux. 
À cet égard, la Cour internationale de Justice, par exemple, est une juridiction comme les autres. 
Elle ne constitue pas d’office une juridiction d’appel ou de cassation à l’égard des autres tribunaux internationaux.
 Exceptions : les décisions de certains organismes ou juridictions à caractère international peuvent être contestées devant la CIJ, car les parties concernées y ont consenti : OACI, tribunaux arbitraux, tribunal administratif de l’OIT. 
**
...
1 – Les organisations internationales
 ...
 Question n°1 : Une organisation internationale (OI) peut-elle être partie à un différend international face à un État ou à une autre OI ? 
 Réponse : Oui, comme le montre l’examen de la pratique internationale.
 Question n°2 : Une organisation internationale (OI) peut-elle recourir à tous les modes de règlement pacifique des différends internationaux ? 
 Réponse : Oui, sauf au règlement judiciaire devant la Cour internationale de Justice (CIJ).
*
 S’agissant de l’ONU, la solution de principe a été donnée par la Cour internationale de Justice (CIJ) dans l’avis consultatif rendu le 11 avril 1949 : Réparation des dommages subis au service des Nations Unies. 
 L’intervention de la Cour trouve son origine dans l’assassinat, en septembre 1948, du comte Bernadotte, médiateur des Nations Unies en Palestine. 
...
**
2 – Les personnes physiques et les entreprises privées
 Le principe, assorti de quelques exceptions, est que l’action des personnes privées n’est pas recevable devant les juridictions interétatiques. Leurs différends sont des différends intraétatiques. Elles doivent donc saisir les différentes juridictions étatiques. 
 Certes, l’individu fait l’objet de nombreuses règles primaires du droit international coutumier ou conventionnel, visant à le protéger dans son pays, contre son propre gouvernement, et à l’étranger, contre les gouvernements étrangers. 
Au demeurant, la Cour internationale de Justice l’a souligné dans les affaires LaGrand2 et Avena3. Cette protection ne se limite pas aux droits personnels.
Les traités bilatéraux relatifs aux investissements confèrent des droits et une protection aux personnes physiques et morales en ce qui concerne leurs droits patrimoniaux. 
 Mais si l’individu a des droits en droit international, mais peu de recours lui sont ouverts.
...
« En prenant fait et cause pour l’un des siens, en mettant en mouvement en sa faveur l’action diplomatique ou l’action judiciaire internationale, cet État fait, à vrai dire, valoir son propre droit, le droit qu’il a de faire respecter, en la personne de ses ressortissants, le droit international. » – Affaire des concessions Mavrommatis en Palestine, Exception d’incompétence, Arrêt du 30 août 1924. CPJI, série A n°2, pp. 637.
 Dans ce dictum, la C.P.J.I. s’inspire sans doute de la thèse avancée en 1758 par Emmerich de Vattel et selon laquelle « quiconque traite mal un citoyen porte indirectement préjudice à l’État, qui doit protéger ce citoyen ».
 Bien sûr, on peut, à l’instar de la Commission du droit international, percevoir une fiction et une exagération dans le fait de soutenir que la protection diplomatique est un droit exclusif de l’État, en ce sens que celui-ci l’exercerait pour son propre compte parce qu’un préjudice causé à un de ses nationaux est considéré comme un préjudice causé à l’État lui-même. 
 En effet, nombre de règles de la protection diplomatique contredisent l’affirmation de la C.P.J.I., en particulier la règle de la continuité de la nationalité (Cf. infra, page 33) qui exige de l’État qu’il prouve que le national lésé est demeuré son national entre le moment où le préjudice a été causé et la date de présentation de la réclamation. 
 Par conséquent, on pourrait ironiser comme le fait la Commission du droit international : 
« "À vrai dire" - pour citer l’arrêt Mavrommatis -, l’État ne fait pas seulement valoir son propre droit. "À vrai dire", il fait aussi valoir le droit de son national lésé. » – Commission du droit international, Projet d’articles sur la protection diplomatique et commentaires y relatifs, 2006.
 Il est toutefois incontestable que la protection diplomatique est mise en œuvre discrétionnairement par l’État, qui est maître du jeu diplomatique ou juridictionnel et qui apparaît devant le juge international comme le titulaire du droit d’agir. 
**
...
o Le réclamant, c’est-à-dire la personne privée (personne physique ou entreprise privée) qui a subi un préjudice,
o L’État prétendument responsable du préjudice causé à la personne privée, donc au réclamant,
o L’État exerçant l’action en protection diplomatique au bénéfice de la personne privée.
...
o la conduite correcte du réclamant (de la personne privée) : théorie dite des « clean hands » (« mains propres »)
o et l’absence de clause Calvo, c’est-à-dire l’absence de renonciation anticipée de la personne privée à se prévaloir de la protection diplomatique de son État national. L’abandon de cette condition s’explique par le fait que, comme nous l’avons indiqué plus haut, la protection diplomatique est un droit de l’État même s’il est exact qu’elle bénéficie à une personne privée.
i – Le lien de nationalité entre la personne privée et l’État exerçant l’action en protection diplomatique
 L’État en droit d’exercer la protection diplomatique est l’État dont le réclamant (la personne privée qui a subi un préjudice) a la nationalité.
 Exception : apatrides et réfugiés. C’est l’État qui les a accueillis qui a le droit d’exercer la protection diplomatique à l’égard des apatrides et réfugiés.
*
 La condition tenant au lien de nationalité appelle trois précisions concernant :
* la règle de la continuité de la nationalité,
* la dualité de nationalités (ou double nationalité),
* la nationalité des sociétés ou entreprises privées.
*
 La règle de la continuité de la nationalité
 Un État n’est en droit d’exercer la protection diplomatique qu’à l’égard d’une personne qui avait sa nationalité de manière continue depuis la date du préjudice jusqu’à la date de la présentation officielle de la réclamation par ledit État. 
 Cette règle bien établie, dite de la continuité de la nationalité, vise à empêcher que les réclamants ne recherchent systématiquement la nationalité la plus avantageuse aux fins de la protection diplomatique. Elle fait donc obstacle à ce que l’on appelle le nationality shopping.
 La dualité de nationalités (ou double nationalité)
 Un État de nationalité ne peut exercer sa protection diplomatique à l’égard d’une personne contre un État dont cette personne a également la nationalité, à moins que la nationalité prépondérante de cette dernière soit celle du premier État en question, tant à la date du préjudice qu’à la date de la présentation officielle de la réclamation. 
Exemple :
Un individu X possède à la fois la nationalité d’un État A et celle d’un État B.
En principe, l’État A ou l’État B peut valablement s’opposer à ce que l’État A ou l’État B exerce sa protection diplomatique au profit de l’individu X à l’encontre de l’État A ou de l’État B.
Exception basée sur la prépondérance, c’est-à-dire sur l’importance des attaches personnelles et professionnelles :
Si la nationalité de l’État A est considérée comme prépondérante, l’État A pourra exerce sa protection diplomatique au profit de l’individu X à l’encontre de l’État B.
Si, en revanche, la nationalité de l’État B est considérée comme prépondérante, l’État B pourra exerce sa protection diplomatique au profit de l’individu X à l’encontre de l’État A.
 La nationalité des sociétés ou entreprises privées
...
Néanmoins, lorsque la société est placée sous la direction de personnes ayant la nationalité d’un autre État ou d’autres États et n’exerce pas d’activités importantes dans l’État où elle a été constituée, et que le siège de l’administration et le contrôle financier de cette société sont tous deux situés dans un autre État, ce dernier est considéré comme l’État de nationalité.
 Lorsque, comme c’est la règle, une société est dotée d'une personnalité juridique indépendante de ses membres (actionnaires ou associés) de sorte que l’on puisse séparer les droits propres de cette société et les droits de ses membres en tant que tels, une distinction s’impose aux fins de la recevabilité de l’action en protection diplomatique :
 Seul l’État dont la société a la nationalité est recevable à exercer sa protection diplomatique à l’égard de cette société lorsque les droits propres de celle-ci sont affectés par un fait illicite d'un autre État ;
 Seul l’État dont l’actionnaire (ou l’associé) de cette société a la nationalité est recevable à exercer sa protection diplomatique à l’égard de cet actionnaire lorsque les droits propres de celui-ci sont affectés par un fait illicite d'un autre État (CDI, projet précité ; voir aussi Barcelona Traction, Light and Power Company, Limited, Arrêt du 5 février 1970. C.I.J. Recueil 1970, p. 3 ; Ahmadou Sadio Diallo (République de Guinée c. République démocratique du Congo), exceptions préliminaires, Arrêt du 24 mai 2007. C.I.J. Recueil 2007, p. 582.
**
ii – L’épuisement préalable des recours internes
 Un État ne peut valablement présenter une réclamation internationale à raison d’un préjudice causé à une personne ayant sa nationalité avant que cette personne ait épuisé tous les recours internes, c’est-à-dire tous les recours existant au sein de l’État prétendument responsable du préjudice.
 La CIJ présente comme suit le contenu et la raison d’être de la règle de l’épuisement des recours internes : 
«[L]a règle selon laquelle les recours internes doivent être épuisés avant qu'une procédure internationale puisse être engagée est une règle bien établie du droit international coutumier. 
Elle a été généralement observée dans les cas où un État prend fait et cause pour son ressortissant dont les droits auraient été lésés dans un autre État en violation du droit international. 
Avant de recourir à la juridiction internationale, il a été considéré en pareil cas nécessaire que l'État où la lésion a été commise puisse y remédier par ses propres moyens, dans le cadre de son ordre juridique interne. » – Affaire de l’Interhandel (Suisse c. Etats-Unis d’Amérique), Arrêt du 21 mars 1959. Cf. aussi Elettronica Sicula S.p.A. (ELSI), Arrêt du 20 juillet 1989. C.I.J. Recueil 1989, p. 15.
 Par « recours internes », on entend les recours ouverts à une personne lésée devant les autorités judiciaires ou administratives, ordinaires ou spéciales, de l’État prétendument responsable du préjudice.
 La règle de l’épuisement préalable des recours internes appelle deux précisions concernant :
* les cas où le réclamant n’a pas à épuiser les recours internes ;
* la charge de la preuve de l’épuisement ou du non-épuisement des recours internes.
*
 Exemples de cas où le réclamant n’a pas à épuiser les recours internes :
...
"Pour une réponse définitive et détaillée, je vous suggère de me rejoindre dans le chat textuel. En mode vocal, je m'en tiens à une présentation générale et synthétique. C'est la différence classique entre le support écrit et l'échange audiovisuel."
